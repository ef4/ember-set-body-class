...
module('Unit | Service | body class', function (hooks) {
  ...
  test('it collects names from all registered components', function (assert) {
    ...
    assert.deepEqual(
      service.get('names'),
      ['dog', 'horse', 'cow'],
      'should collect names from registered components'
    );
    ...
    assert.deepEqual(
      service.get('names'),
      ['dog'],
      'should update whenever component was deregistered'
    );
    ...
    assert.deepEqual(
      service.get('names'),
      ['cow'],
      'should update whenever component name was updated'
    );
    ...
    assert.deepEqual(
      service.get('names'),
      ['horse', 'cow'],
      'should work with repeated class names'
    );
